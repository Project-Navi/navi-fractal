...
| `NO_WINDOW_PASSES_R2` | `"no_window_passes_r2"` | No contiguous radius window achieves the minimum \( R^2 \) threshold. The graph likely has no power-law scaling regime. |
...
| `R2_TOO_LOW` | `"r2_too_low"` | \( R^2 \) below gate threshold. |
